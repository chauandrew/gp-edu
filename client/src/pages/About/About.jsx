...
const About = () => {
    return (
        <div className="page-content">
            ...
            <p style = {{fontSize: "12px", position: "absolute", left: 328, top: 260, fontFamily: "Helvetica Neue", letterSpacing: "0.07em"}}>
            ...
            <p style = {{fontSize: "12px", position: "absolute", left: 328, top: 385, fontFamily: "Helvetica Neue", letterSpacing: "0.07em"}}>
            ...
            <p style = {{fontSize: "12px", position: "absolute", left: 328, top: 510, fontFamily: "Helvetica Neue", letterSpacing: "0.07em"}}>
