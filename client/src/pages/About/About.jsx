...
const About = () => {
    return (
        <div className="page-content">
            ...
            <h2 style = {{fontSize: "18px", position: 'absolute', left: 530, top: 205, fontWeight: "bold", fontFamily: "DM Sans", letterSpacing: "0.07em"}}>
                COLLABORATION
            </h2>
            <p style = {{fontSize: "12px", position: "absolute", left: 528, top: 242, fontFamily: "Helvetica Neue", letterSpacing: "0.07em", lineHeight: "169.5%"}}>
                Meet classmates from your courses. <br /> Ask or answer questions on course <br /> forums – anytime and anywhere.
            </p>
            <h2 style = {{fontSize: "18px", position: 'absolute', left: 530, top: 473, fontWeight: "bold", fontFamily: "DM Sans", letterSpacing: "0.07em"}}>
                ACHIEVABLE GOALS
            </h2>
            <p style = {{fontSize: "12px", position: "absolute", left: 528, top: 510, fontFamily: "Helvetica Neue", letterSpacing: "0.07em", lineHeight: "169.5%"}}>
